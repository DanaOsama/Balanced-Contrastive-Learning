...
python main.py --lr 0.05 --epochs 2000 --dataset aptos \
                ...
                --alpha 1.0 --beta 0.35 --ce_loss 'EQLv2' --loss_req 'LC' --logit_adjust 'train' \
                --many_shot_thr 600 --low_shot_thr 200 --user_name 'salwa' --pretrained True --recalibrate True --recalibrate_static True \
