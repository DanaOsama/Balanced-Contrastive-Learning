...
python main.py --lr 0.05 --epochs 1000 --dataset isic \
                ...
                # --resume "log/isic_resnet50_batchsize_110_epochs_1000_temp_0.07_lr_0.05_sim-sim_alpha_1.0_beta_0.35_schedule_[860, 880]_recalibrate_False_Salwa_ce_loss_LC_fbmmqa/bcl_ckpt.pth.tar"